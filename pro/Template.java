...
public class Template extends Application {  //zorg dat de class overerft van Application
    ...
    public void start(Stage stage) {   //geef de stage mee als argument
        ...
        newCircle.relocate(70, 70);
        newCircle.setCenterX(20);
        newCircle.setCenterY(20);
        newCircle.setRadius(80);
        newCircle.setFill(Color.GRAY);
        group1.getChildren().add(newCircle);

        //Maakt een nieuw text veld aan
        TextField newTextField = new TextField(); //textField P:Opdracht2
        newTextField.relocate(50, 80);
        group1.getChildren().add(newTextField);

        //Maakt een NIEUW stuk text aan doormiddel een string
        Text newText = new Text("Opdracht 3 Node"); //text P:Opdracht3
        newText.relocate(50, 110);
        newText.setFill(Color.RED);
        group1.getChildren().add(newText);


        //Geeft de X en Y waardes waar de animatie heen moet
        ...
        FillTransition fill = new FillTransition(Duration.millis(750), Color.BLUE, Color.RED); //voor transition

        //Bouwt de transitie voor de animatie op
        ParallelTransition transition = new ParallelTransition(newCircle, translateTransition, fill);
        transition.setCycleCount(Timeline.INDEFINITE);
        transition.setAutoReverse(true);
        //Speelt bovenstaande transitie af als animatie
        transition.play();
        ...
        /*
        * Er verandert niks, dit is omdat 'group1' een child is van de parent group 'rootNode'.
        * De rootNode parent group, voert alles uit van zijn children (group1 in dit geval).
        * Dit betekend dat naast volgorde van wat er ingeladen wordt, niks verandert.
        */
        ...
        */
        ...
        /*
        * 'Circle' gebruikt, verandert van kleur en beweegt over het scherm.
        */
