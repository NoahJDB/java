...
public class Main extends Application{  //zorg dat de class overerft van Application
    public void start(Stage stage){   //geef de stage mee als argument
        ...
        //textveld
        TextField newTextField = new TextField();  //opdracht 2
        newTextField.relocate(50, 80);
        group1.getChildren().add(newTextField);


        //nieuwe text
        Text newText = new Text("Opdracht 3 Node"); //opdracht3
        ...
        FillTransition fill = new FillTransition(Duration.millis(750), Color.YELLOW, Color.PURPLE);
